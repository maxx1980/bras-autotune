...
в systemd unit нужных приложений, 0 прибивает в 0 ядру 0 1 к двум
...
- десктопные процессора Intel(R) Core(TM) i7-10900 теринировали клиентм 8Gb+nat,
при равномерно загрузке ядер 55-65% в чнн.
